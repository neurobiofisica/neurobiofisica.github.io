    <div id="vmenu">
      ...
      <ul class="menulateral">
        <li class="menulateralfirst"><a href="#">Por que mosca?</a></li>
        <li class="menulateral"><a href="#">Por que siris?</a></li>
        <li class="menulateral"><a href="#">Por que peixes?</a></li>
        <li class="menulateral"><a href="#">Simulações?</a></li>
        <li class="menulateral"><a href="#">Oportunidades!</a></li>
      </ul>
